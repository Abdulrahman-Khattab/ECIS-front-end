...
const SingleOrderProductsDetails = () => {
  const { orderProductsColumns: columns, singleOrderProducts } =
    useGlobalOrderContext();

  let rows = singleOrderProducts;
...
export default SingleOrderProductsDetails;
